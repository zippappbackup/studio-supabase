...
export function DataImporterClientPage() {
    ...
    const handleUpload = async () => {
        ...
        setIsUploading(true);
        toast({ title: "Upload Started", description: "Processing vendor file on the server. This may take a moment..." });
    ...
    const handleLiveExport = async () => {
        ...
        setIsExporting(true);
        toast({ title: "Exporting Live Data", description: "Fetching all vendors from the database. This may take a moment..." });
        ...
        try {
            ...
            toast({ title: "Export Successful", description: `Exported ${allVendors.length} vendors.` });
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    <Label className="font-semibold">Export Live Database</Label>
                     <Button onClick={handleLiveExport} disabled={isExporting} className="w-full">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Upload a JSON array of vendor objects. The system will perform deduplication against the live database and only create new vendors. Writes are batched in groups of 300.
                    </p>
