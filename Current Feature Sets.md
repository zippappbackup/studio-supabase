...
*   **Photo Migration Tool**: A utility to fix broken image links by migrating photos from temporary Google Places URLs to permanent Firebase Storage, ensuring images don't disappear.